                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header d-flex align-items-start justify-content-between">
                            <h4 class="header-title">List of permissions</h4>
                            <button type="button" class="btn btn-info" data-bs-toggle="modal"
                                data-bs-target="#role-modal">Add permission</button>
                        </div>
                        <div class="card-body">
                            <table id="basic-datatable" class="table table-striped dt-responsive nowrap w-100">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="{{ url('/permissions/edit/'.$permission->id.'')}}" class="btn btn-success btn-sm me-1 tooltips"
                                                data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Edit"> <i
                                                    class="ri-pencil-fill"></i> </a>
                                            <a href="{{ url('/permissions/delete/'.$permission->id.'')}}" class="btn btn-danger btn-sm me-1 tooltips"
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title" id="roleModal">Create a permission</h4>
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="card">
                                        <div class="card-body">
                                            <form action="{{ route('submitpermissions')}}" class="needs-validation" novalidate method="POST">
                                                @csrf
                                                <div class="mb-3">
